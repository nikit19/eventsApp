...
public abstract class Urls {
    ...
    public static String BASE_URL = "https://open-event-api.herokuapp.com/v1/events/1/";

    public static String FACEBOOK_BASE_URL = "https://graph.facebook.com";

    public static String LOKLAK_BASE_URL = "https://api.loklak.org";
    ...
    public static final String APP_LINK = "https://open-event-api.herokuapp.com/v1/events/1/";
